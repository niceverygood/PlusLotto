...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      admin_import_815_collision_batch: {
        Args: {
          p_batch_id: string
      ...
      portal_member_recos_for_site: {
        Args: { p_phone: string; p_pw: string; p_source_site: string }
        Returns: Json
      }
      ...
      sms_is_legacy_import_held: { Args: { p_phone: string }; Returns: boolean }
    }
    Enums: {
